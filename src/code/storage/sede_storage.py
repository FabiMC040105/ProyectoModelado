"""
Este módulo proporciona funciones para la gestión de sedes mediante archivos JSON.
...
- JSON_SEDE: Ruta del archivo JSON que contiene la información de las sedes.
